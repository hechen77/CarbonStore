<template>
<uni-shadow-root class="vant-dist-datetime-picker-index"><van-picker class="van-datetime-picker" active-class="active-class" toolbar-class="toolbar-class" column-class="column-class" :title="title" :columns="columns" :item-height="itemHeight" :show-toolbar="showToolbar" :visible-item-count="visibleItemCount" :confirm-button-text="confirmButtonText" :cancel-button-text="cancelButtonText" @change="onChange" @confirm="onConfirm" @cancel="onCancel"></van-picker></uni-shadow-root>
</template>
...
global['__wxRoute'] = 'vant/dist/datetime-picker/index'
...
export default global['__wxComponents']['vant/dist/datetime-picker/index']
</script>
