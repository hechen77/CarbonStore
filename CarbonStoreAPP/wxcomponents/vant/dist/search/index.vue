<template>
<uni-shadow-root class="vant-dist-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'vant/dist/search/index'
...
export default global['__wxComponents']['vant/dist/search/index']
</script>
