<template>
<uni-shadow-root class="vant-dist-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = 'vant/dist/col/index'
...
export default global['__wxComponents']['vant/dist/col/index']
</script>
