<template>
<uni-shadow-root class="vant-dist-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'vant/dist/count-down/index'
...
export default global['__wxComponents']['vant/dist/count-down/index']
</script>
