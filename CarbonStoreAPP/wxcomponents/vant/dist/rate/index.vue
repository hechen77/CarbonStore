<template>
<uni-shadow-root class="vant-dist-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'vant/dist/rate/index'
...
export default global['__wxComponents']['vant/dist/rate/index']
</script>
