<template>
<uni-shadow-root class="vant-dist-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'vant/dist/sticky/index'
...
export default global['__wxComponents']['vant/dist/sticky/index']
</script>
