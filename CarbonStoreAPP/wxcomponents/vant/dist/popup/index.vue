<template>
<uni-shadow-root class="vant-dist-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll"></van-overlay>
...
global['__wxRoute'] = 'vant/dist/popup/index'
...
export default global['__wxComponents']['vant/dist/popup/index']
</script>
